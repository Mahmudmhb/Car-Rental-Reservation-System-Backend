...
export const initialPayment = async (paymentData: any) => {
  ...
  const response = await axios.post(config.payment_url!, {
    ...
    success_url: `https://assignment-3-ten-eta.vercel.app/api/payment/confirmation?transactionId=${paymentData.transactionId}&status=success`,
    fail_url: `https://assignment-3-ten-eta.vercel.app/api/payment/confirmation?status=faild`,
